      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock,     label: 'Last Updated', value: detail.updatedAt ? new Date(detail.updatedAt).toLocaleDateString('en-LK', { day: 'numeric', month: 'short', year: 'numeric' }) : 'No updates yet', color: 'text-gray-500 dark:text-gray-400' },
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-5">
          ...
          <p className="text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
            Your complaint has been received and will be reviewed by the LabourLink team.
            If your complaint involves a specific agency, they will be notified and requested to respond.
            You will receive updates here as the status changes.
          </p>
        </div>
      </div>
    </div>
